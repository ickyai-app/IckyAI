...
export default function TemplatesLibrary({ userId }: TemplatesLibraryProps) {
  ...
  return (
    <div className="max-w-4xl">
      <h2 className="text-3xl font-bold text-white mb-6">📧 Email Templates</h2>
                ...
                <div className="space-y-4">
                  ...
                  <div className="bg-blue-900 p-4 rounded-lg border border-blue-700">
                    ...
                    <ul className="text-sm text-blue-200 space-y-1">
                      <li>• <code className="bg-blue-800 px-2 py-1 rounded">{'{{contact_name}}'}</code></li>
                      <li>• <code className="bg-blue-800 px-2 py-1 rounded">{'{{company_name}}'}</code></li>
                      <li>• <code className="bg-blue-800 px-2 py-1 rounded">{'{{date}}'}</code></li>
                    </ul>
                  </div>
                </div>
              </div>
