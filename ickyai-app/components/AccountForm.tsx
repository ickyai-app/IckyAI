    ...
    <div className="bg-gray-800 p-8 rounded-xl shadow-lg border border-gray-700 max-w-2xl">
      ...
      <form onSubmit={handleSubmit} className="space-y-5">
        ...
        <button
          ...
          className="w-full bg-gradient-to-r from-blue-600 to-blue-700 hover:from-blue-700 hover:to-blue-800 disabled:opacity-50 text-white font-semibold py-3 px-4 rounded-lg transition shadow-lg hover:shadow-xl transform hover:scale-105"
        >
