          ...
          <div className="bg-gray-800 p-8 rounded-xl shadow-lg border border-gray-700 max-w-2xl">
            ...
            <div className="space-y-6">
              <div className="bg-blue-900 p-6 rounded-lg border-l-4 border-blue-400">
                <h3 className="font-bold text-blue-300 mb-3 text-lg">🎯 Today's Top 3 Priorities</h3>
              ...
              <div className="bg-purple-900 p-6 rounded-lg border-l-4 border-purple-400">
                <h3 className="font-bold text-purple-300 mb-3 text-lg">💬 Smart Insights</h3>
                <ul className="space-y-2 text-purple-200 text-sm">
                  <li>📊 You have {accounts.filter(a => a.status === 'prospect').length} prospects waiting for follow-up</li>
                  <li>🎯 Average deal size: ${(stats.totalValue / Math.max(accounts.length, 1)).toLocaleString()}</li>
                  <li>⏰ Best call time: Tuesday-Thursday, 10am-2pm</li>
                </ul>
              </div>
            </div>
          </div>
